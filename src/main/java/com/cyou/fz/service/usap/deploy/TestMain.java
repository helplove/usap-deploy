    ...
    public static void main(String[] args) throws Exception {
        ...
        **/
        ...
        if ((input.get("lang")).equals(1)) {
            ...
            HttpRequest request = HttpUtil.createPost(Constants.getTestUrlPre() + "shtml/project/doUpload");
        ...
        //原先参数
        JSONObject updateData = Update.getProjectByAppId(""+ input.get("appId"),sessionId, Constants.getTestUrlPre());
        //需要发布的参数
        ...
        if (updateData == null) {
            ...
            HttpRequest updateRequest = HttpUtil.createPost(Constants.getTestUrlPre() + "shtml/project/saveProject");
            ...
            HttpRequest updateRequest = HttpUtil.createPost(Constants.getTestUrlPre() + "shtml/project/upgradeProject");
            updateRequest.disableCache();
            updateRequest.form(deployMap);
            updateRequest.cookie("JSESSIONID=" + sessionId);
